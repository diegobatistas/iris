    ...
    try {
      ...
      case 'moddroid':
        ...
        case 'join':
            ...
            const minMem = 01 // PRECISA TER ISSO DE MEMBRO PRA ENTRAR
            ...
            if (check.size < minMem) return kill.reply(from, 'Só posso funcionar em grupos com mais de 01 pessoas.', id)
            if (check.status == 200) {
